        ...
        <div className='col-span-5 text-white p-3 bg-black flex gap-6 items-center '>
          ...
          <div className='flex   w-full flex-1 flex-col gap-10'>
                <div className='flex w-full items-center justify-around'>
                     <ul className='flex flex-col gap-0 md:gap-3'>
                      <li className=''><a className='uppercase sm:text-sm text-[6px] md:text-md' href="">shop</a></li>
                      <li><a className='uppercase sm:text-sm text-[6px] md:text-md' href="">lookbook</a></li>
                      <li><a className='uppercase sm:text-sm text-[6px] md:text-md' href="">item num</a></li>
                     </ul>
                     <ul className='flex flex-col gap-0 md:gap-3'>
                      <li><a className='uppercase sm:text-sm text-[6px] md:text-md' href="">jornal</a></li>
                      <li><a className='uppercase sm:text-sm text-[6px] md:text-md' href="">contacts</a></li>
                      <li><a className='uppercase sm:text-sm text-[6px] md:text-md' href="">item num</a></li>
                     </ul>
                </div>
                <div className='lg:pl-16 pl-4 text-[#999] space-y-2'>
                  <p className='underline cursor-pointer sm:text-sm text-[8px] md:text-md'>UA: +3 8096 272 2100</p>
                  <p className='uppercase underline cursor-pointer sm:text-sm text-[8px] md:text-md '>mail@halo-lab.com</p>
                </div>
          </div>
          <div className='flex-1 space-y-10'>
              ...
              <form className='flex  relative items-center'>
               <input className='uppercase text-[6px] sm:text-sm md:text-md lg:text-lg w-[80%] py-2 outline-none border-[#999] focus:border-white  pr-8 md:pr-14 lg:pr-20 border-b-[1px] bg-transparent' type="email" placeholder='email address' />
